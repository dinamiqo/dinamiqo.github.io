...
this;a.dom.querySelector(".loading-container");if(a.stat.disqusLoaded)a.stat.current="disqus",a.dom.querySelector("#idisqus").style.display="none",a.dom.querySelector("#disqus_thread").style.display="block";else{var c=k.createElement("script");c.src="https://"+a.opts.forum+".disqus.com/embed.js";c.dataset.timestamp=Date.now();c.onload=function(){a.stat.disqusLoaded=!0};c.onerror=function(){1==a.opts.mode&&a.getlist()};var b=new XMLHttpRequest;b.open("GET","//disqus.com/next/config.json?"+Date.now(),!0);
